    ...
    <div>
      ...
      <section className='flex flex-col-reverse md:flex-row w-full justify-between md:gap-24 gap-5 md:px-[100px] px-[25px] py-[25px] md:py-[50px]'  >
          ...
          <div className='w-[100%] md:w-[50%]'>
               <img src="/images/bg1.jpg" alt="" className='' />
          </div>
      </section>
      <section className='flex flex-col md:flex-row w-full justify-between md:gap-24 gap-5 md:px-[100px] px-[25px] py-[25px] md:py-[50px]'  >
          <div className='w-[100%] md:w-[50%]'>
               <img src="/images/mission.jpg" alt="" className='' />
          </div>
          <div className='w-[100%] md:w-[50%] pt-5'>
               <h1 className='font-bold text-[#131316] md:text-4xl text-xl md:mb-[24px] mb-[10px]'>Mission and Vision</h1>
               <p className='text-[14px] font-[500] text-[#56616B] leading-6'>Our mission at IFZINA is to deliver innovative and sustainable solutions that exceed client expectations while contributing to the socio-economic development of Nigeria. We envision being the leading EPC provider in the region, recognized for our commitment to excellence and integrity.</p>
          </div>
      </section>
      <section className='flex flex-col-reverse md:flex-row w-full justify-betweenmd:gap-24 gap-5 md:px-[100px] px-[25px] py-[25px] md:py-[50px]'  >
          
          <div className='w-[100%] md:w-[50%] pt-5'>
               <h1 className='font-bold text-[#131316] md:text-4xl text-xl md:mb-[24px] mb-[10px]'> Values and Philosophy</h1>
               <p className='text-[14px] font-[500] text-[#56616B] leading-6'>At  IFZINA, we are guided by the values of integrity, professionalism, collaboration, and excellence. We believe in fostering long-term relationships with our clients, suppliers, and stakeholders based on mutual respect and trust.</p>
          </div>
          <div className='w-[100%] md:w-[50%]'>
               <img src="/images/mission.jpg" alt="" className='' />
          </div>
      ...
      <section className='flex flex-col md:flex-row w-full justify-between md:gap-24 gap-5 md:px-[100px] px-[25px] py-[25px] md:py-[50px]'  >
          ...
          <div className='w-[100%] md:w-[50%] pt-5'>
               ...
               <p className='text-[14px] font-[500] text-[#56616B] leading-6'>Established in 20XX, IFZINA has rapidly emerged as a trusted name in the Nigerian EPC industry. With a proven track record of successful projects and a dedicated team of professionals, we continue to set new standards of excellence in our field.</p>
          </div>
      </section>
      <section className='flex flex-col-reverse md:flex-row w-full justify-between md:gap-24 gap-5 md:px-[100px] px-[25px] py-[25px] md:py-[50px]'  >
          <div className='w-[100%] md:w-[50%] pt-5'>
               <h1 className='font-bold text-[#131316] md:text-4xl text-xl md:mb-[24px] mb-[10px]'>Team Members</h1>
               <p className='text-[14px] font-[500] text-[#56616B] leading-6'>Our team comprises highly skilled engineers, project managers, and technical experts with extensive experience in their respective fields. Led by visionary leaders and seasoned industry professionals, we are committed to delivering high-quality solutions tailored to meet our clients' needs.</p>
          </div>
          <div className='w-[100%] md:w-[50%]'>
               <img src="/images/mission.jpg" alt="" className='' />
          </div>
      ...
      <section className='flex flex-col md:flex-row w-full justify-between md:gap-24 gap-5 md:px-[100px] px-[25px] py-[25px] md:py-[50px]'  >
          ...
          <div className='w-[100%] md:w-[50%] pt-5'>
               ...
               <p className='text-[14px] font-[500] text-[#56616B] leading-6'>What sets IFZINA apart is our unwavering commitment to quality, safety, and innovation. We leverage cutting-edge technologies and best practices to deliver cost-effective solutions while maintaining the highest standards of performance and reliability.</p>
          </div>
      </section>
      <section className='flex flex-col-reverse md:flex-row w-full justify-between md:gap-24 gap-5 md:px-[100px] px-[25px] py-[25px] md:py-[50px]'  >
      ...
      <section className='flex flex-col-reverse md:flex-row w-full justify-between md:gap-24 gap-5 md:px-[100px] px-[25px] py-[25px] md:py-[50px]'  >
          ...
          <div className='w-[100%] md:w-[50%] pt-5'>
               ...
               <p className='text-[14px] font-[500] text-[#56616B] leading-6'>Integrity is at the core of everything we do at IFZINA. We conduct our business with honesty, transparency, and accountability, adhering to the highest ethical standards. Our commitment to ethical behavior guides our interactions with clients, partners, and stakeholders, ensuring mutual trust and long-term relationships built on integrity.</p>
          </div>
          <div className='w-[100%] md:w-[50%]'>
               <img src="/images/mission.jpg" alt="" className='' />
          </div>
      ...
      <section className='flex flex-col md:flex-row w-full justify-between md:gap-24 gap-5 md:px-[100px] px-[25px] py-[25px] md:py-[50px]'  >
          ...
          <div className='w-[100%]  pt-5'>
               ...
               <p className='text-[14px] font-[500] text-[#56616B] leading-6 text-center'>Don't just take our word for it. Hear what our clients have to say about working with us</p>

               <div className='flex md:flex-row flex-col md:gap-20 gap-5 mt-10'>
                    <div className='w-[100%] md:w-[50%] flex md:flex-row flex-col gap-5 rounded-lg bg-[#EFF1F6] md:p-[32px] p-[20px] '>
